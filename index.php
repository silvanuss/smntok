          ...
          <div class="chat">
            <div class="chat-container">
              <div class="user-bar">
                ...
                <div class="avatar">
                  <img src="https://i.pinimg.com/750x/df/eb/51/dfeb51e22c076b269470dea421c58bcd.jpg" alt="Avatar" style="object-fit: cover; width: 40px; height: 40px;">
                </div>
              ...
              <div class="conversation">
                <div class="conversation-container">
                  ...
                  <div class="message received">
                    ...
                    <img src="img/img001.png" width="100%" id="myPicture">
                    <span class="metadata"><span class="time">12:30 AM</span></span>
                  </div>
            ...
            <section>
              <div class="join" style="">
                <span class="icon" style="background: url(https://i.pinimg.com/750x/df/eb/51/dfeb51e22c076b269470dea421c58bcd.jpg) no-repeat; background-size: cover;"></span>
                <div class="content">
                  <h1>Viral 18+</h1>
                  ...
                  <p class="desc">
                    ...
                    <span class="more" onclick="myFunction()" id="myBtn">Baca selengkapnya<br>
                      ...
                      <script id="rendered-js">
                        ...
                        var memes = [
                          'Grup dibuat oleh ~adminsange',
                          'Grup dibuat oleh ~kuntul',
                          'Grup dibuat oleh ~viralid',
                          'Grup dibuat oleh ~io',
                          'Grup dibuat oleh ~hmm',
                          'Grup dibuat oleh ~vidhot'
                        ];
